...
public class TestThreeNodes100CarsWithConnection {
    ...
    public void run() throws Throwable {
        ...
        SimulationEdge edge1 = new SimulationEdge(0, 1, 0, 0, 0, 100, 40, 2, new EdgeShape(Arrays.asList(node0, node1)));
        SimulationEdge edge2 = new SimulationEdge(2, 0, 0, 0, 0, 100, 40, 1, new EdgeShape(Arrays.asList(node1, node0)));
...
//        graphBuilder.addEdge(edge4);
    ...
    public static void main(String[] args) {
        new JUnitCore().run(TestThreeNodes100CarsWithConnection.class);
    }
}
