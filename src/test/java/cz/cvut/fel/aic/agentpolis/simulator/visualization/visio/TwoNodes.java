...
import cz.cvut.fel.aic.agentpolis.simmodel.environment.model.congestion.drive.TestCrossroad;
...
public class TwoNodes {
    ...
    public void run(){
        ...
        SimulationEdge edge1 = new SimulationEdge(0, 1,  0, 0, 10000, 40, 1, new EdgeShape(Arrays.asList(node1, node2)),null);
    ...
    public static void main(String[] args) {
        VisualTests.runVisualTest(TwoNodes.class);
    }
}
