...
public class TestCrossroad {
    ...
    public void run(){
        ...
        SimulationNode node3 = new SimulationNode(2, 0, 0, 0, 10000, 10000, 0);
        SimulationNode node4 = new SimulationNode(3, 0, 0, 0, 0, 20000, 0);
        ...
        SimulationEdge edge5 = new SimulationEdge(1, 3, 0, 0, 0, 100, 40, 1);
        SimulationEdge edge6 = new SimulationEdge(3, 1, 0, 0, 0, 100, 40, 1);
        ...
        for(int i = 0; i < trips.length / 2; i++){
            Trip<SimulationNode> trip = new Trip<>(node1, node2, node4);
            trips[i] = trip;
        }
        
        for(int i = trips.length / 2; i < trips.length; i++){
            Trip<SimulationNode> trip = new Trip<>(node3, node2, node4);
            trips[i] = trip;
        }
