package cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.importer.init;
...
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.HouseholdId;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.RouteId;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.TripId;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.VehicleDataModel;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.VehicleTemplate;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.VehicleTemplateId;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.importer.DistributionForVehicleTypeXml;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.importer.HouseholdWithTheirVehiclesXml;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.importer.NumberOfVehiclesForVehicleTypeXml;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.importer.VehicleDataModelXml;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.importer.VehicleTemplateIdXml;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.importer.VehicleTemplateXml;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.importer.VehicleTempleteForSpecificRouteIdXml;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.vehiclemodel.importer.VehicleTempleteForSpecificTripIdXml;
