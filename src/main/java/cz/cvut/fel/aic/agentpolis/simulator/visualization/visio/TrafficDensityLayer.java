 ...
 */
@Singleton
public class TrafficDensityLayer<E extends AgentPolisEntity & MovingEntity, ES extends EntityStorage<E>> extends AbstractLayer {

    private static final int EDGE_WIDTH = 6;

    private static final double MAX_SLACK = 1;
