...
import cz.cvut.fel.aic.agentpolis.siminfrastructure.logger.agent.activity.VehicleDrivingActivityLogger;
import cz.cvut.fel.aic.agentpolis.siminfrastructure.planner.trip.DepartureTripItem;
...
import cz.cvut.fel.aic.agentpolis.simmodel.agent.activity.movement.callback.DrivingFinishedActivityCallback;
...
import cz.cvut.fel.aic.agentpolis.simmodel.environment.model.action.driving.DriveMovingAction;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.model.action.driving.DriveWithDepartureMovingAction;
...
import cz.cvut.fel.aic.agentpolis.simmodel.environment.model.action.vehicle.WaitingVehicleAction;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.model.entityvelocitymodel.query.VehicleInfoQuery;
import cz.cvut.fel.aic.agentpolis.simmodel.environment.model.linkedentitymodel.action.LinkEntityAction;
