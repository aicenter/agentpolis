...
public class TimeProvider {
	 ...
	 */
	@Inject
	public TimeProvider(EventProcessor eventProcessor) {
	...
	public TimeProvider(EventProcessor eventProcessor, LocalDate initDate) {
		this(eventProcessor, initDate.atStartOfDay(ZoneId.systemDefault()));
	}

	public TimeProvider(EventProcessor eventProcessor, ZonedDateTime initDate) {
		super();
