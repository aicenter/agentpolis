 ...
 * @author Zdenek Bousa
 */
public class RoadNodeExtended extends RoadNode {

    public RoadNodeExtended(int id, long osmId, int latE6, int lonE6, int projectedLat, int projectedLon, int elevation, boolean isParkAndRide, boolean isBikeSharingStation) {
        super(id, osmId, latE6, lonE6, projectedLat, projectedLon, elevation, isParkAndRide, isBikeSharingStation);
    }

    public RoadNodeExtended(int id, long sourceId, GPSLocation location, boolean isParkAndRide, boolean isBikeSharingStation) {
